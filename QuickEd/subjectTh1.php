<?php 
    ...
    $result = $mysqli->query("SELECT * FROM subjects where subjectteacher='$username'") or die($mysqli->error);
?>
    ...
    <div class="nav container-fluid ">
        ...
        <span class="col">
            ...
            <span class="col-md">
                ...
                <a href="./subjectTh1.html" class="btn small-bold active">Subjects</a>
            </span>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['studentsenrolled']?></td>
                        <td><form action="process.php" method="POST">
                            <input type="hidden" name="subjectcode" value="<?php echo $row['subjectcode']?>">
                            <input type="hidden" name="subjecttitle" value="<?php echo $row['subjecttitle']?>">
                            <input type="hidden" name="classroomcode" value="<?php echo $row['classroomcode']?>">
                            <button class="tableButton" name="viewSubjectTh">VIEW</button><button name="deleteSubjectTh" class="tableButton">DELETE</button>
                        </form></td>
