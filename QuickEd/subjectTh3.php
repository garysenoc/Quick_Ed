<?php include "database.php";
    ...
    $result = $mysqli->query("SELECT * FROM $tableTitle WHERE studentID='$studentID'") or die($mysqli->error);
...
<body>
    ...
    <div class="container profile-body">
        <h2><?php echo $row['name']?></h2><!--USE PHP-->
        <div class="container bodyContainer">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo 'a' . $i?></td>
                        <td class="failSample"><?php echo $row['a' . $i]?></td>
                        <td><button class="tableButton">EDIT</button><button class="tableButton">SEND</button></td>
                        
                    </tr>
                    <?php
                        }
                    ?>
                    <?php $n = 2; for($i = 1; $i <= $n; $i++){
                        ?>
                    <tr>
                        <td><?php echo 'p' . $i?></td>
                        <td class="passSample"><?php echo $row['p' . $i]?></td>
                        <td><button class="tableButton">EDIT</button><button class="tableButton">SEND</button></td>
            ...
            <div class="row justify-content-start">
                <h4 class="failSample">Grade: <?php echo $row['grade']?></h4> 
            </div>
            <div class="row justify-content-end">
                <form action="process.php" method="POST">
                    <input type="hidden" name="subject" value="<?php echo $tableTitle?>">
                    <input type="hidden" name="studentID" value="<?php echo $studentID?>">
                    <input type="hidden" name="teacher" value="<?php echo $username?>">
                    <button name="sendAll" type="submit">Send All</button>
                </form>
