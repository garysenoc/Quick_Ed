...
<body>
    ...
    <form class="col-lg-6 offset-lg-3 " action="process.php" method="POST">
        <div class="row justify-content-center ">
            <form>
                ...
                <div class="row">
                    <div class="col-12" style="margin-bottom: 10px; width:500px;">
                        <input type="text" class="form-control" placeholder="School ID"
                            style="background-color:#EFF0F6;color: #A0A3BD;" name="schoolID">
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12" style="margin-bottom: 10px; width:500px;">
                        <select id="inputState" class="form-control"
                            style="width:470px;background-color:#EFF0F6;color: #A0A3BD;" name="subject">
                ...
                <div class="row">
                    ...
                    <div class="col-12" style="width:300px; margin-left: 440px;">
                        <div class="custom-control custom-checkbox">
                            <br><button class="btn button" type="submit" name="register"
