...
<div class="container">
        <form class="login-form" method="POST" action="process.php">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp" placeholder="Email Adress" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="contact" id="contact" aria-describedby="emailHelp" placeholder="Contact No." required>
            </div>
            <div class="form-group">
                <label for="school">School</label>
                <input type="text" class="form-control" name="school" id="school" aria-describedby="emailHelp" placeholder="School" required>
            </div>
            <div class="form-group">
                <label for="schoolID">School ID</label>
                <input type="text" class="form-control" name="schoolID" id="schoolID" aria-describedby="emailHelp" placeholder="school ID" required>
            </div>
            <div class="row">
                <div class="col">
            ...
            <div class="input-group mb-3">
                        <input type='hidden' class="hidden" nacme='accountType' value='student'>
                        <input type="checkbox">
